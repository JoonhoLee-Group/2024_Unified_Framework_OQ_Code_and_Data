...
crestbound[8]=ITnorm[8]*Inorm[7]**2*Inorm[6]**3*Inorm[5]**4*Inorm[4]**5*Inorm[3]**6*Inorm[2]**7*Inorm[1]**8*I0norm**9
print(I0_val)

for i in range(1,9):
    crestbound[i]*=1/(cb1)**i
plt.semilogy(crestbound[1:8])
plt.ylabel("crestonormbound_N (no dimension normalization)/crestonormbound_1^N")
plt.xlabel("N")
plt.show()