...
#filename = f'jobsdone\jobgqme0.51.0\dyn0.5beta5delt0.1ohmicity1.0.h5'
...
import matplotlib.pyplot as plt
from pyeom.inverse.inverse import *
filename = f'heomforK0.015.0/tmax5.0beta5alpha0.5s0.5initial1.h5'

h5 = h5py.File(filename,'r')
#kmax=14
A1 = np.transpose(h5["rho"])

filename = f'heomforK0.015.0/tmax5.0beta5alpha0.5s0.5initial2.h5'

h5 = h5py.File(filename,'r')
#kmax=14
A2 = np.transpose(h5["rho"])

filename = f'heomforK0.015.0/tmax5.0beta5alpha0.5s0.5initial3.h5'

h5 = h5py.File(filename,'r')
#kmax=14
A3 = np.transpose(h5["rho"])

filename = 'heomforK0.015.0/tmax5.0beta5alpha0.5s0.5initial4.h5'
...
filename="heomforK0.145.00.5/tmax45.0beta5alpha0.5s0.5initial1.h5"
#filename="heompaper10.115.0/heompaper10.115.0/tmax15.0beta5alpha0.5s1initial1.h5"
#filename="heompaper10.115.0/heompaper10.115.0/tmax15.0beta5alpha0.1s1initial1.h5"
...
plt.savefig("plots/Dynnew0505.png",dpi=1000)
plt.show()