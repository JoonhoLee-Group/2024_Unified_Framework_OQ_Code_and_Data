...
import matplotlib.pyplot as plt
from pyeom.inverse.inverse import *
filename = f'heompaper10.115.0/heompaper10.115.0/tmax15.0beta5alpha0.5s1initial1.h5'

h5 = h5py.File(filename,'r')
#kmax=14
A1 = np.transpose(h5["rho"])

filename = f'heompaper10.115.0/heompaper10.115.0/tmax15.0beta5alpha0.5s1initial2.h5'

h5 = h5py.File(filename,'r')
#kmax=14
A2 = np.transpose(h5["rho"])

filename = f'heompaper10.115.0/heompaper10.115.0/tmax15.0beta5alpha0.5s1initial3.h5'

h5 = h5py.File(filename,'r')
#kmax=14
A3 = np.transpose(h5["rho"])

filename = 'heompaper10.115.0/heompaper10.115.0/tmax15.0beta5alpha0.5s1initial4.h5'
...
ax.semilogy(range(2,14+1)*delt,x[1:14], color='#5E091A', ls="none",markersize=12,marker='x')
...
plt.yticks(fontsize=15)
plt.ylim([10**(-4),30])
plt.savefig(f"KINorm051",dpi=1000,bbox_inches="tight")
plt.show()