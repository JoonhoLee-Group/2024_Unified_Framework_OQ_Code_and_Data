...
plt.rc("ytick")
fig = plt.figure(figsize=(3,2))  # width=8 inches, height=6 inches
...
ax2 = ax.twinx()
ax2.plot(range(2,kmax+1)*delt,x[1:], color='#5E091A')
ax2.plot(range(2,14+1)*delt,x[1:14], color='#5E091A', ls="none",marker='x')
ax2.set_ylabel(r'$\|\tilde{I}\|_O$', color='#5E091A',fontsize=15)
ax2.tick_params('y', color='#5E091A')
...
#plt.savefig(f"KINorm0505",dpi=1000,bbox_inches="tight")
plt.show()